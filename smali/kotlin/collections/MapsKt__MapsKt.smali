...
.method public static final varargs hashMapOf([Lkotlin/Pair;)Ljava/util/HashMap;
    ...
    .local v1, "$receiver":Ljava/util/HashMap;
    const/4 v2, 0x0
    ...
    .end local v1    # "$receiver":Ljava/util/HashMap;
...
.method public static final mapKeys(Ljava/util/Map;Lkotlin/jvm/functions/Function1;)Ljava/util/Map;
    ...
    .line 748
    .local v3, "$i$a$1$associateByTo":I
    .local v10, "it$iv":Ljava/util/Map$Entry;
    invoke-interface {v10}, Ljava/util/Map$Entry;->getValue()Ljava/lang/Object;

    move-result-object v10

    .end local v3    # "$i$a$1$associateByTo":I
    .end local v10    # "it$iv":Ljava/util/Map$Entry;
...
.method public static final mapKeysTo(Ljava/util/Map;Ljava/util/Map;Lkotlin/jvm/functions/Function1;)Ljava/util/Map;
    ...
    .line 347
    .local v2, "$i$a$1$associateByTo":I
    .local v7, "it":Ljava/util/Map$Entry;
    invoke-interface {v7}, Ljava/util/Map$Entry;->getValue()Ljava/lang/Object;

    move-result-object v7

    .end local v2    # "$i$a$1$associateByTo":I
...
.method public static final minus(Ljava/util/Map;Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    .local v1, "$receiver":Ljava/util/Map;
    const/4 v2, 0x0
    ...
    .end local v1    # "$receiver":Ljava/util/Map;
...
.method public static final varargs mutableMapOf([Lkotlin/Pair;)Ljava/util/Map;
    ...
    .local v1, "$receiver":Ljava/util/LinkedHashMap;
    const/4 v2, 0x0
    ...
    .end local v1    # "$receiver":Ljava/util/LinkedHashMap;
    .end local v2    # "$i$a$1$apply":I
    check-cast v0, Ljava/util/Map;
...
.method public static final toMap(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    .end local v0    # "$receiver":Ljava/util/Map;
...
.method public static final toMap(Ljava/util/Map;Ljava/util/Map;)Ljava/util/Map;
    ...
    .local v1, "$i$a$4$apply":I
    invoke-interface {v0, p0}, Ljava/util/Map;->putAll(Ljava/util/Map;)V

    .end local v0    # "$receiver":Ljava/util/Map;
    .end local v1    # "$i$a$4$apply":I
    return-object p1
.end method
