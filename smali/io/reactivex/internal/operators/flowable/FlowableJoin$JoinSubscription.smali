...
.method drain()V
    ...
    iput v14, v1, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->leftIndex:I
    ...
    invoke-direct {v0, v1, v7, v14}, Lio/reactivex/internal/operators/flowable/FlowableGroupJoin$LeftRightEndSubscriber;-><init>(Lio/reactivex/internal/operators/flowable/FlowableGroupJoin$JoinSupport;ZI)V
    ...
    .line 253
    .local v21, "right":Ljava/lang/Object;, "TTRight;"
    ...
    .end local v21    # "right":Ljava/lang/Object;, "TTRight;"
    .local v4, "right":Ljava/lang/Object;, "TTRight;"
    .local v23, "missed":I
    :try_start_2
    invoke-interface {v0, v6, v4}, Lio/reactivex/functions/BiFunction;->apply(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v24, "right":Ljava/lang/Object;, "TTRight;"
    :try_start_3
    const-string v4, "The resultSelector returned a null value"
    ...
    .end local v24    # "right":Ljava/lang/Object;, "TTRight;"
    nop
    ...
    .restart local v24    # "right":Ljava/lang/Object;, "TTRight;"
    :cond_9
    ...
    .end local v0    # "w":Ljava/lang/Object;, "TR;"
    .local v25, "w":Ljava/lang/Object;, "TR;"
    ...
    invoke-direct {v0, v5}, Lio/reactivex/exceptions/MissingBackpressureException;-><init>(Ljava/lang/String;)V
    ...
    .line 254
    .end local v25    # "w":Ljava/lang/Object;, "TR;"
    ...
    .end local v23    # "missed":I
    .end local v24    # "right":Ljava/lang/Object;, "TTRight;"
    .end local v26    # "ex":Ljava/lang/Throwable;
    .local v4, "missed":I
    .restart local v5    # "ex":Ljava/lang/Throwable;
    .restart local v21    # "right":Ljava/lang/Object;, "TTRight;"
    :catch_2
    move-exception v0
    ...
    invoke-static {v0, v12, v13}, Lio/reactivex/internal/util/BackpressureHelper;->produced(Ljava/util/concurrent/atomic/AtomicLong;J)J
    ...
    .end local v17    # "e":J
    .local v5, "e":J
    .local v27, "end":Lio/reactivex/internal/operators/flowable/FlowableGroupJoin$LeftRightEndSubscriber;
    ...
    invoke-interface {v0, v15, v4}, Lio/reactivex/functions/BiFunction;->apply(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .end local v4    # "right":Ljava/lang/Object;, "TTRight;"
    .local v30, "right":Ljava/lang/Object;, "TTRight;"
    :try_start_6
    const-string v4, "The resultSelector returned a null value"
    ...
    .end local v0    # "w":Ljava/lang/Object;, "TR;"
    .local v31, "w":Ljava/lang/Object;, "TR;"
    new-instance v0, Lio/reactivex/exceptions/MissingBackpressureException;
    ...
    invoke-direct {v0, v7}, Lio/reactivex/exceptions/MissingBackpressureException;-><init>(Ljava/lang/String;)V
    ...
    .line 315
    .end local v31    # "w":Ljava/lang/Object;, "TR;"
    .end local v32    # "idx":I
    ...
    .end local v30    # "right":Ljava/lang/Object;, "TTRight;"
    .end local v32    # "idx":I
    .restart local v4    # "right":Ljava/lang/Object;, "TTRight;"
    .restart local v7    # "idx":I
    :catch_5
    ...
    .end local v7    # "idx":I
    .local v0, "exc":Ljava/lang/Throwable;
    .restart local v30    # "right":Ljava/lang/Object;, "TTRight;"
    .restart local v32    # "idx":I
    :goto_6
    invoke-virtual {v1, v0, v3, v2}, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->fail(Ljava/lang/Throwable;Lorg/reactivestreams/Subscriber;Lio/reactivex/internal/fuseable/SimpleQueue;)V
    ...
    .end local v13    # "r":J
    .end local v27    # "end":Lio/reactivex/internal/operators/flowable/FlowableGroupJoin$LeftRightEndSubscriber;
    .end local v30    # "right":Ljava/lang/Object;, "TTRight;"
    .end local v32    # "idx":I
    :cond_10
    goto :goto_7
